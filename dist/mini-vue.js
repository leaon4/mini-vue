(() => {
    ...
    function S(e) {
        ...
        return {
            type: f,
            name: t,
            value: n && { type: i, content: n.content },
        };
    }
    function _(e, t) {
        switch (e.type) {
                    ...
                    ...r.map((e) => {
                        ...
                        switch (e.name) {
                            case 'bind':
                                return `${t}: ${O(e.exp)}`;
                            case 'on':
                                const n = `on${t[0].toUpperCase()}${t.slice(
                                    1
                                )}`;
                                let r = e.exp.content;
                                return (
    ...
    function P(t) {
        ...
        const o = new Proxy(t, {
            ...
            set(e, t, o, s) {
                ...
                return (
                    r(o, l) &&
                        (W(e, t), n(e) && e.length !== c && W(e, 'length')),
                    i
                );
            },
        });
    ...
    window.MiniVue = {
        ...
        resolveComponent: function (e) {
            return (
                ...
                (ne[e] ||
                    ne[s(e)] ||
                    ne[((t = s(e)), t[0].toUpperCase() + t.slice(1))])
            );
            var t;
        },
                            ...
                            ? ((t.checked = e.includes(t.value)),
                              (t.onChange = (e) => {
                                  const { value: t } = e.target,
                                      n = new Set(r());
                                  n.has(t) ? n.delete(t) : n.add(t), o([...n]);
                              }))
                            : ((t.checked = e),
                              (t.onChange = (e) => {
                                  o(e.target.checked);
